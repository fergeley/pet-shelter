...
worktree. Start a Worktree chat in the Codex desktop app when available; in a CLI environment,
create and select a Git worktree explicitly. Prefer that to any protocol written here. A rule the
