          ...
          <div className="space-y-3 p-4 bg-muted/40 border border-border rounded-lg animate-in">
            ...
            {generated?.svg && (
              <div className="flex items-center gap-4">
                <div
                  className="size-28 shrink-0 rounded-md border border-zinc-300 bg-white p-1 [&>svg]:w-full [&>svg]:h-full"
            ...
            {generated?.error && (
              <div className="flex items-start gap-2 rounded-lg border border-destructive/30 bg-destructive/10 p-2.5">
                ...
                <p className="text-[11px] text-destructive font-medium">{generated.error}</p>
              </div>
            )}

            {uploadOverridesPayload && (
              <div className="flex items-start gap-2 rounded-lg border border-amber-300 bg-amber-50 dark:border-amber-800 dark:bg-amber-950/40 p-2.5">
