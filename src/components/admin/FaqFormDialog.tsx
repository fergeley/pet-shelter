...
export function FaqFormDialog({
  ...
  // Reset the form whenever the dialog opens on a different record, mirroring
  // the render-phase key comparison used by PetFormDialog.
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>
            {editingFaq ? "Edit FAQ Entry" : "Add a New FAQ Entry"}
          </DialogTitle>
          <DialogDescription>
