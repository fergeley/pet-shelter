...
export interface QrChannelPresentation {
  ...
  subtitle: string;
  /**
   * Brand accent, as a CSS custom-property reference so globals.css stays the
   * single source of truth. Applied inline because Tailwind cannot build a
